...
.. image:: https://img.shields.io/pypi/pyversions/pytest-reporter.svg
    :target: https://pypi.org/project/pytest-reporter
    :alt: Python versions

.. image:: https://travis-ci.org/christiansandberg/pytest-reporter.svg?branch=master
    :target: https://travis-ci.org/christiansandberg/pytest-reporter
    :alt: See Build Status on Travis CI

.. image:: https://ci.appveyor.com/api/projects/status/github/christiansandberg/pytest-reporter?branch=master
    :target: https://ci.appveyor.com/project/christiansandberg/pytest-reporter/branch/master
